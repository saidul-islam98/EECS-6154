...
if uploaded_file is not None:
    ...
    if st.button('Enhance Image'):
        ...
        enhanced_illumination = enhance_illumination_tikh(illumination_map, lambda_reg=0.25, num_iter=100, learning_rate=0.01)
        ...
        #Own code
        final_image_own = enhanced_reflectance_own * enhanced_illumination
